...
func dataFish() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/fish", size: 8277, mode: os.FileMode(420), modTime: time.Unix(1501852700, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dataSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/sh", size: 3541, mode: os.FileMode(420), modTime: time.Unix(1501852732, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
